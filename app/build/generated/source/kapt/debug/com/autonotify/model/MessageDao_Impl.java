...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessage = new EntityInsertionAdapter<Message>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`text`) VALUES (nullif(?, 0),?)";
      }
  ...
  @Override
  public Object getRecentMessages(final Continuation<? super List<Message>> $completion) {
    final String _sql = "SELECT * FROM messages ORDER BY id DESC LIMIT 5";
      ...
      public List<Message> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Message(_tmpId,_tmpText);
            _result.add(_item);
          }
          return _result;
        } finally {
